...
const themeLight = createTheme({
  ...
  return (
    ...
    //               />
    //             </ListItem>
    //             <IconButton edge="end" aria-label="delete" onClick={e=>{navigate('/edit',{ state: { quizId:doc?.id, name:doc?.name}})}}>
    //                   <EditIcon />
    //                 </IconButton>
    //             </div>
    //           ))}
        ...
        Pick a quiz
          ...
          <Demo>
            ...
            {docs?.map(doc=>(
              <div>
                <ListItem
               onClick={e=>{navigate('/quiz',{ state: { quizId:doc?.id, name:doc?.name}})}}
                sx={{
                    backgroundColor: 'f3e575',
                    '&:hover': {
                        backgroundColor: '#ce93d8',
                ...
                <Box sx={{display:'inline-block', width:50, float:'right'}}>    <PlayCircleOutlineIcon sx={{display:'inline-block'}} onClick={e=>{navigate('/quiz',{ state: { quizId:doc?.id, name:doc?.name}})}}/></Box>
                </ListItem>
